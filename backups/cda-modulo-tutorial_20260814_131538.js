...
var CDA_TUTORIAL_CONTEUDO = [
  ...
  {
    id: 'compras', titulo: 'Histórico de Compras',
  ...
  {
    id: 'tarefas-geral', titulo: 'Tarefas & Follow-up',
  ...
  {
    id: 'painelgerencial', titulo: 'Painel Gerencial',
  ...
  {
    id: 'permissoes', titulo: 'Permissões por Submódulo (só Administradores)',
...
async function montarModuloTutorial(containerId, opts) {
  ...
  function gerarHtmlWord() {
    ...
    return '<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word" xmlns="http://www.w3.org/TR/REC-html40">' +
      ...
      '<p><i>Módulo Comercial — gerado em ' + hoje + '</i></p>' +
      corpoHtml +
