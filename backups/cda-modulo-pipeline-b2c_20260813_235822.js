...
async function montarModuloPipelineB2C(containerId) {
      ...
      '<div class="mo-box">' +
        ...
        '<div class="mo-b">' +
          ...
          '<div id="pb2c-tabpanel-tarefas" style="display:none">' +
            ...
            '<button class="btn" id="pb2c-tf-cancelar-edicao" style="margin-top:12px;display:none">Cancelar edição</button>' +
          '</div>' +
        '</div>' +
        '<div class="mo-f">' +
  ...
  function renderTarefasDoLead() {
    ...
    box.innerHTML = lista.length ? lista.map(function (t) {
      ...
      return '<div class="pb2c-hist-item' + (emEdicao ? ' pb2c-tarefa-destaque' : '') + '" data-abrir-tarefa-pipeline="' + t.id + '" style="display:flex;justify-content:space-between;align-items:flex-start;gap:8px;cursor:pointer">' +
        '<div><b>' + t.descricao + '</b> ' +
