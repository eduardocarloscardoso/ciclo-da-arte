...
async function cdaSalvarParametrosSegmentacao(o) {
  // Gold pode ser definido manualmente pelo usuário; se não vier, cai pra média Premium/VIP
  var valorGold = (o.valorGold != null && !isNaN(o.valorGold))
    ? o.valorGold
    : Math.round(((o.valorPremium + o.valorVip) / 2) * 100) / 100;
  const row = {
